...
-   this is a huge dataset! there are 3793 rows, so 3793 cases or 3793 observations.
-   however, only 5 variables which makes this very doable.
-   mostly numerical data, and one categorical data
...
-   The % tells us the percentage of all codes that were predicted correctly by the model. Would this be kind of like the interrater reliability?
...
-   accurance = 0.87, or 87%. 

-   I would say this is a fairly good prediction of the overall data. 
