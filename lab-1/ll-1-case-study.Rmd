...
-   this is a huge dataset! there are 3793 rows, so 3793 cases or 3793
    observations.
...
-   The % tells us the percentage of all codes that were predicted
    correctly by the model. Would this be kind of like the interrater
    reliability?
