...
-   The feature engineering did improve the mean predictive accuracy that I found in the case study (m =8.90). I tried playing around by adding additional predictors and remove predictors to the model in this badge activity and it appears that the mean predictive accuracy hovers around this 20.5 range. 
