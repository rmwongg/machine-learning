...
```{r}
fitted_model_resamples%>% ##this needs to be fitted_model_resamples
    unnest(.metrics) %>% 
    filter(.metric == "rmse") # we also get another metric, the RSQ; we focus just on RMSE for now
...
metric. This can be interpreted in the precise same way as our accuracy
